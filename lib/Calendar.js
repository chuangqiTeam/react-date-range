...
var Calendar = (function (_Component) {
    ...
    _createClass(Calendar, [{
        ...
        value: function changeMonth(direction, event) {
            ...
            var newMonth = this.getShownDate().clone().add(direction, 'months');

            var compareMinMonth = minDate ? (0, _moment2['default'])([minDate.year(), minDate.month()]) : (0, _moment2['default'])([1970, 7]);
            var compareMaxMonth = maxDate ? (0, _moment2['default'])([maxDate.year(), maxDate.month()]) : (0, _moment2['default'])([2200, 1]);
            var compareNewMonth = (0, _moment2['default'])([newMonth.year(), newMonth.month()]);
            if (compareNewMonth.isBefore(compareMinMonth)) {
                return;
            }

            if (compareNewMonth.isAfter(compareMaxMonth)) {
                return;
            }
        ...
        key: '_onSelectMonth',
        value: function _onSelectMonth(event) {
            var currentMonth = this.getShownDate().month();
            var direction = event.target.value - currentMonth;
        ...
        key: '_onSelectYear',
        value: function _onSelectYear(event) {
            ...
            var toBeMonth = (0, _moment2['default'])([event.target.value, shownDate.month()]);
            var compareMinMonth = minDate ? (0, _moment2['default'])([minDate.year(), minDate.month()]) : (0, _moment2['default'])([1970, 7]);
            var compareMaxMonth = maxDate ? (0, _moment2['default'])([maxDate.year(), maxDate.month()]) : (0, _moment2['default'])([2200, 1]);

            if (toBeMonth.isBefore(compareMinMonth)) {
                toBeMonth = compareMinMonth;
            }

            if (toBeMonth.isAfter(compareMaxMonth)) {
                toBeMonth = compareMaxMonth;
            }

            var direction = toBeMonth.diff((0, _moment2['default'])([shownDate.year(), shownDate.month()]), 'months');
        ...
        value: function renderMonthAndYear(classes) {
            ...
            var showMonthArrow = _props6.showMonthArrow;
            ...
            var yearArr = [];
            var minYear = minDate ? minDate.year() : (0, _moment2['default'])().subtract(1, 'years').year();
            var maxYear = maxDate ? maxDate.year() : (0, _moment2['default'])().year();
            var startYear = minYear;
            while (minYear <= maxYear && startYear <= maxYear) {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            'select',
                            { className: 'monthyearselect', value: monthNum, onChange: this._onSelectMonth.bind(this), style: styles.monthYearSelect },
                            MONTHES.map(function (v, i) {
                                if (minDate) {
                                    if (year < minDate.year()) return null;
                                    if (year == minDate.year() && i < minDate.month()) return null;
                                }
                                if (maxDate) {
                                    if (year > maxDate.year()) return null;
                                    if (year == maxDate.year() && i > maxDate.month()) return null;
                                }
                    ...
                    _react2['default'].createElement(
                        ...
                        yearArr.length === 1 ? year : _react2['default'].createElement(
                            'select',
                            { className: 'monthyearselect', value: year, onChange: this._onSelectYear.bind(this), style: styles.monthYearSelect },
                            yearArr.map(function (v) {
                                return _react2['default'].createElement(
                                    'option',
                                    { value: v, key: v },
                                    v
        ...
        value: function renderDays(classes) {
            ...
            var range = _props8.range;
            var minDate = _props8.minDate;
            var maxDate = _props8.maxDate;
            var format = _props8.format;
            var onlyClasses = _props8.onlyClasses;
            var disableDaysBeforeToday = _props8.disableDaysBeforeToday;
            var specialDays = _props8.specialDays;
        ...
        value: function render() {
            ...
            var onlyClasses = _props9.onlyClasses;
            var classNames = _props9.classNames;
